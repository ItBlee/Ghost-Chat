...
public class ServerGUI extends JFrame {
    ...
    /**
     * Gửi message của Server đến com.itblee.core.Client
     */
    public static String messageOfServerHandle(String message, AAUser to) {
        ...
        to.addResponseList(com.itblee.utils.JsonParser.toJson(serverPacket));
        to.addDateList(LocalDateTime.now().toString());
        return EncryptUtil.encrypt(com.itblee.utils.JsonParser.toJson(serverPacket), to.getSecretKey()); //mã hóa bằng secret key trước khi gửi
    }
